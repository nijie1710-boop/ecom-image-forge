...
serve(async (req: Request) => {
  ...
  try {
    ...
    const promptText = [
      ...
      "For each screen, provide both visual planning and short direct-render copy that can be generated directly inside the image.",
      ...
      "overlayTitle must be short, strong, readable, and suitable as a real poster title rendered directly in the image.",
      "overlayBodyLines must contain 2 to 4 short lines, each line concise and commercially useful for direct in-image typography. Avoid fake slogans and avoid generic filler.",
      "When the target language is Chinese, prefer clean modern free commercial Chinese sans-serif font directions such as Source Han Sans SC, Alibaba PuHuiTi, or HarmonyOS Sans SC.",
